...
<html>
  <head>
    <meta charset="utf-8">
    <title>大分とりっぷ🐓</title>
    <link rel="stylesheet" href="./ZIGOKU.css">
    ...
    <div class="balloon">
       ...
       <div class = "detail">
        ...
        <ul class="wrapper">
            ...
            <li class="fadeInUp">↓（電車で20分280円）</li>
            <li class="fadeInUp">別府大学駅<hr></li>
            <li class="fadeInUp">↓</li>
            <li class="fadeInUp">別大駅前（亀の井バス）<hr></li>
            <li class="fadeInUp">↓（バスで10分　190円）</li>
            <li class="fadeInUp">地獄原・ひょうたん温泉<hr></li>
            <li class="fadeInUp">↓</li>
            <li class="fadeInUp"><a href="https://goo.gl/maps/RmgYXQecQFpgMNas9" target="_blank" rel="noopener">
                ひょうたん温泉館内散策(温泉利用780円、食事代1000円※想定)</a><hr></li>
